...
```{r}
base_url = "https://scottish-premier.predictthefootball.com"
  print(base_url)
  index_page <- "/profile/index"
  my_url <- str_c(base_url, index_page)
  page <- session_jump_to(sess, my_url)
...
```{r}
my_url <- "https://scottish-premier.predictthefootball.com/site/stats?fixtureid=230"
